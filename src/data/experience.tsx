...
export const EXPERIENCE_TIMELINE = [
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-8">
          Completed Board of Secondary School Certification from Satya Sai EM High School, Vijayawada, Andhra Pradesh. <br />
          Cumulative GPA: 6.0
        </p>
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-8">
          Completed Diploma in Electrical & Electronics Engineering from Govt. Polytechnic College, Vijayawada, Andhra Pradesh. <br />
          Cumulative GPA: 6.5
        </p>
        <div className="grid grid-cols-2 gap-4">
          <BlurImage
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-8">
          Pursuing Bachelor of Technology in Computer Science and Engineering from SRK Institute of Technology, JNTU-K, Vijayawada, Andhra Pradesh. <br />
          Cumulative GPA: 7.45
        </p>
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-4">
          Completed multiple virtual internships and certifications to enhance technical skills and gain practical experience:
        </p>
      ...
      <div>
        ...
        <div className="mb-8">
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            ✅ AWS Cloud Virtual Internship (Apr-Jun 2024)
          </div>
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            ✅ Edu-skills Academy Ethical Hacking Virtual Internship (Jul-Sep 2024)
          </div>
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            ✅ Fortinet Network Security Associate Virtual Internship (Oct-Dec 2024)
          </div>
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            ✅ Microchip Embedded System Developer Internship (Jan-Mar 2025)
          </div>
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            ✅ Python Full Stack Developer Virtual Internship (Apr-Jun 2025)
          </div>
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base mt-4">
            ✅ Cyber Security with Kali Linux by APSSDC Summer Internship (Jun-Jul 2024)
          </div>
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            ✅ Full Stack Developer (MERN Stack) Summer Internship (Jun-Jul 2025)
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <BlurImage
