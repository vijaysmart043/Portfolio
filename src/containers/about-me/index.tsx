              ...
              <div className="relative flex flex-1 flex-col gap-6">
                <div className="flex w-full md:flex-row flex-col items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="relative z-20 text-sm sm:text-base text-neutral-500 font-medium">
                        SRK Institute of Technology | JNTU-K
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-6 flex-1 flex flex-col items-center justify-center">
                  ...
                  <h2 className="text-sm/[1.125rem] text-black md:text-base/[1.375rem] dark:text-neutral-400 [&_b]:md:font-semibold [&_strong]:md:font-semibold">
                    As a highly motivated and results-driven engineering graduate, I aim to leverage my academic background and hands-on project experience to contribute effectively to a dynamic team. I seek a challenging position where I can apply my technical skills, problem-solving abilities, and innovative thinking to deliver impactful solutions.
                  </h2>
                </div>
